const therapists = [
    {
        name: "乐康博",
        avatar: "./img/avatar/乐康博1.jpg",
        price: "400",
        pricetime: "/50分钟",
        info: "硕士毕业于北京师范大学临床与咨询专业。本科毕业于新西兰奥克",
        experience: "200+小时",
        city: "珠海",
        gender: "男",
        mode: ["视频", "面对面"],
        major: ["情绪困扰", "个人成长", "压力管理"],
        detail: {
            pics: ["./img/avatar/乐康博1.jpg"],
            sentence: "路一直都在",
            intro: ["硕士毕业于北京师范大学临床与咨询专业。 ", "本科毕业于新西兰奥克兰大学心理学专业。", "曾在北京师范大学心理健康服务中心；", "中央民族大学心理健康教育与咨询中心；", "北京师范大学职业发展与就业指导中心从事心理咨询工作。", "现就职于北京师范大学（珠海校区）心理健康服务中心", "LGBTQ+友善咨询师", "200+小时个体咨询经历，持续接受督导。", "以人本为基础的整合取向咨询师。"],
    ...
    {
        name: "王雨萌",
        avatar: "./img/avatar/王雨萌1.png",
        price: "200",
        pricetime: "/50分钟",
        info: "北京师范大学临床与咨询心理专业硕士，接受系统心理咨询受训。",
        experience: "200+小时",
        city: "北京",
        gender: "女",
        mode: ["视频"],
        major: ["亲密关系", "个人成长", "情绪适应","学业职场"],
        detail: {
            pics: ["./img/avatar/王雨萌1.png", "../img/therapists/王雨萌/1.PNG", "../img/therapists/王雨萌/2.PNG"],
            sentence: "",
    ...
    {
        name: "陈丹",
        avatar: "./img/avatar/陈丹1.png",
        price: "300",
        pricetime: "/小时",
        info: "我是北京师范大学临床与咨询方向毕业的硕士研究生",
        experience: "286小时",
        city: "北京",
        gender: "女",
        mode: ["视频"],
        major: ["亲密关系", "人际关系", "情绪管理"],
        detail: {
            pics: ["./img/avatar/陈丹1.png", "../img/therapists/陈丹/1.JPEG", "../img/therapists/陈丹/2.PNG"],
    ...
    {
        name: "李思漫",
        avatar: "./img/avatar/李思漫1.png",
        price: "300",
        pricetime: "（线下￥400）",
        info: "中山市第三人民医院心理治疗师。北京师范大学临床与咨询心理硕",
        experience: "300+小时",
        city: "广东",
        gender: "女",
        mode: ["视频", "面对面"],
        major: ["情绪调节", "自我探索与成长", "青少年咨询", "学业工作压力", "人际关系"],
        detail: {
            pics: ["./img/avatar/李思漫1.png", "../img/therapists/李思漫/1.JPEG"],
    ...
    {
        name: "刘俣瑶",
        avatar: "./img/avatar/刘俣瑶1.JPEG",
        price: "300",
        pricetime: "",
        info: "北京师范大学心理学部临床与咨询心理专业硕士",
        experience: "400+小时",
        city: "上海",
        gender: "女",
        mode: ["视频", "面对面"],
        major: ["个人成长", "亲密关系", "学业压力", "亲子关系", "讨好型人格"],
        detail: {
            pics: ["./img/avatar/刘俣瑶1.JPEG", "../img/therapists/刘俣瑶/1.jpg", "../img/therapists/刘俣瑶/2.jpg", "../img/therapists/刘俣瑶/3.jpg", "../img/therapists/刘俣瑶/4.jpg", "../img/therapists/刘俣瑶/5.jpg"],
    ...
    {
        name: "孙凌",
        avatar: "./img/avatar/孙凌1.JPEG",
        price: "800",
        pricetime: "/50分钟",
        info: "北京师范大学心理学院临床与咨询方向博士，国家二级心理咨询师",
        experience: "1000+小时",
        city: "珠海",
        gender: "女",
        mode: ["面对面"],
    ...
    {
        name: "张雨帆",
        avatar: "./img/avatar/张雨帆1.JPEG",
        price: "300",
        pricetime: "/50分钟",
        info: "北京师范大学应用心理硕士（临床与咨询心理方向）",
        experience: "650+小时",
        city: "北京",
        gender: "男",
        mode: ["视频"],
        major: ["人际沟通", "亲密关系", "情绪调节", "拖延", "自我探索"],
        detail: {
            pics: ["./img/avatar/张雨帆1.JPEG", "../img/therapists/张雨帆/1.PNG", "../img/therapists/张雨帆/2.JPEG", "../img/therapists/张雨帆/3.JPEG"],
            sentence: "我说的不一定对。心理咨询不是治病，而是在一个安全稳定的场合请专业人士根据你的需求提供量身定制的服务。我愿意认真倾听你的故事，不会对你叙述的内容做出主观评价，并且希望通过咨询能够为你提供一些新的视角。在梳理清楚目前感到困扰的问题之后，也许你会尝试一些改变，也许你会发现维持现状带来的收益而选择保持不变，又或许你会找到在变与不变之外的“第三条路”，我期待着陪你一起走过这一段梳理和探索的旅程。",
    ...
    {
        name: "李明远",
        avatar: "./img/avatar/李明远1.jpeg",
        price: "300",
        pricetime: "/50分钟（线下￥400/50分钟）",
        info: "北京师范大学临床与咨询心理学专业硕士，曾在北京师范大",
        experience: "700+小时",
        city: "北京",
        gender: "男",
        mode: ["视频", "面对面"],
        major: ["情绪管理", "个人成长", "家庭沟通"],
        detail: {
            pics: ["./img/avatar/李明远1.jpeg", "../img/therapists/李明远/1.JPEG", "../img/therapists/李明远/2.PNG"],
